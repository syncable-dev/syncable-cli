...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Bh9ReuAT.js");
...
const manifest = { "cc35041ac8534be1df357d50dcecc9c79d69232d0d2da0a89a0d930737c7ec36": {
  functionName: "getApiBase_createServerFn_handler",
  importer: () => import("./assets/api-C6MFPO9a.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-wq7tchx4.js").then((n) => n.r);
