use crate::{
    ...
    cli::{ToolsCommand, OutputFormat, SeverityThreshold, DisplayFormat, SecurityScanMode},
    generator,
};
...
pub async fn handle_tools(command: ToolsCommand) -> crate::Result<()> {
    use crate::analyzer::{tool_installer::ToolInstaller, dependency_parser::Language};
    use std::collections::HashMap;
    use termcolor::{ColorChoice, StandardStream, WriteColor, ColorSpec, Color};
