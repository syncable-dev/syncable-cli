...
fn get_python_technology_rules() -> Vec<TechnologyRule> {
    vec![
        ...
        TechnologyRule {
            ...
            file_indicators: vec!["manage.py".to_string(), "settings.py".to_string(), "urls.py".to_string()],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec!["app.py".to_string(), "wsgi.py".to_string()],
        },
        TechnologyRule {
            ...
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec!["main.py".to_string()],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            name: "ASGI Server".to_string(),
            category: TechnologyCategory::Runtime,
            confidence: 0.85,
            dependency_patterns: vec!["uvicorn".to_string(), "hypercorn".to_string(), "daphne".to_string(), "asgiref".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec![],
            file_indicators: vec!["asgi.py".to_string()],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec!["development.ini".to_string(), "production.ini".to_string()],
        },
        TechnologyRule {
            name: "TurboGears".to_string(),
            category: TechnologyCategory::BackendFramework,
            confidence: 0.85,
            dependency_patterns: vec!["turbogears".to_string(), "tg.devtools".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec![],
        ...
        TechnologyRule {
            ...
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec![".streamlit/config.toml".to_string()],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::FrontendFramework,
            confidence: 0.90,
            dependency_patterns: vec!["dash".to_string(), "dash-core-components".to_string(), "dash-html-components".to_string()],
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::FrontendFramework,
            confidence: 0.90,
            dependency_patterns: vec!["panel".to_string(), "holoviz".to_string()],
            requires: vec!["Bokeh".to_string()],
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec!["holoviews".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec!["fire".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            is_primary_indicator: false,
            alternative_names: vec![],
            file_indicators: vec!["celery.py".to_string(), "celeryconfig.py".to_string()],
        },
        TechnologyRule {
            name: "RQ".to_string(),
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.85,
            dependency_patterns: vec!["rq".to_string(), "django-rq".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["python-rq".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
