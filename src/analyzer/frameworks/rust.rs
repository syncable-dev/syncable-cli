...
fn get_rust_technology_rules() -> Vec<TechnologyRule> {
    vec![
        ...
        TechnologyRule {
            ...
            requires: vec![],
            conflicts_with: vec!["Actix Web".to_string(), "Axum".to_string()],
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec!["Rocket.toml".to_string()],
        },
        TechnologyRule {
            name: "Warp".to_string(),
            category: TechnologyCategory::BackendFramework,
            ...
            requires: vec!["Tokio".to_string()],
            conflicts_with: vec!["Actix Web".to_string(), "Rocket".to_string()],
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec![],
        },
        ...
        TechnologyRule {
            ...
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec!["rwf.toml".to_string()],
        },
        TechnologyRule {
            name: "Salvo".to_string(),
            category: TechnologyCategory::BackendFramework,
            confidence: 0.90,
            dependency_patterns: vec!["salvo".to_string(), "salvo_core".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec![],
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.90,
            dependency_patterns: vec!["gotham".to_string(), "gotham_derive".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec![],
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec!["iron-web".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec!["nickel-web".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.85,
            dependency_patterns: vec!["serde".to_string(), "serde_derive".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec![],
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["toml-rs".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
            name: "ron".to_string(),
            ...
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["rusty-object-notation".to_string()],
            file_indicators: vec![],
        },
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec!["clap-rs".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.85,
            dependency_patterns: vec!["tracing".to_string(), "tracing-subscriber".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec![],
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["rust-log".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            requires: vec![],
            conflicts_with: vec!["chrono".to_string()],
            is_primary_indicator: false,
            alternative_names: vec![],
            file_indicators: vec![],
        },
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["image-rs".to_string()],
            file_indicators: vec![],
        },
        ...
        TechnologyRule {
            ...
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["nom-parser".to_string()],
            file_indicators: vec![],
        },
        TechnologyRule {
            name: "pest".to_string(),
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.80,
            dependency_patterns: vec!["pest".to_string(), "pest_derive".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec![],
