...
fn get_jvm_technology_rules() -> Vec<TechnologyRule> {
    vec![
        ...
        TechnologyRule {
            ...
            confidence: 0.95,
            dependency_patterns: vec!["org.springframework.boot:spring-boot".to_string(), "spring-boot-starter".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec!["spring".to_string()],
            file_indicators: vec!["application.properties".to_string(), "application.yml".to_string(), "application.yaml".to_string()],
        },
        TechnologyRule {
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.95,
            dependency_patterns: vec!["io.quarkus:quarkus-core".to_string(), "io.quarkus:quarkus".to_string()],
            requires: vec![],
            conflicts_with: vec!["Spring Boot".to_string()],
            is_primary_indicator: true,
            file_indicators: vec!["application.properties".to_string(), "src/main/resources/META-INF/microprofile-config.properties".to_string()],
            alternative_names: vec![],
        },
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.95,
            dependency_patterns: vec!["io.micronaut:micronaut-core".to_string(), "io.micronaut:micronaut-runtime".to_string()],
            requires: vec![],
            conflicts_with: vec!["Spring Boot".to_string(), "Quarkus".to_string()],
            is_primary_indicator: true,
            file_indicators: vec!["micronaut-cli.yml".to_string()],
            alternative_names: vec![],
        },
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.95,
            dependency_patterns: vec!["io.helidon:helidon-webserver".to_string(), "io.helidon:helidon-microprofile".to_string()],
            requires: vec![],
            conflicts_with: vec!["Spring Boot".to_string()],
            is_primary_indicator: true,
            file_indicators: vec![],
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.95,
            dependency_patterns: vec!["io.vertx:vertx-core".to_string(), "io.vertx:vertx-web".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
            file_indicators: vec![],
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.95,
            dependency_patterns: vec!["com.typesafe.play:play".to_string(), "com.typesafe.play:play-java".to_string()],
            requires: vec![],
            conflicts_with: vec!["Spring Boot".to_string()],
            is_primary_indicator: true,
            alternative_names: vec!["play".to_string()],
            file_indicators: vec!["conf/application.conf".to_string(), "conf/routes".to_string()],
        },
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.90,
            dependency_patterns: vec!["jakarta.platform:jakarta.jakartaee-api".to_string(), "jakarta.servlet:jakarta.servlet-api".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::BackendFramework,
            confidence: 0.95,
            dependency_patterns: vec!["io.ktor:ktor-server-core".to_string(), "io.ktor:ktor-server-netty".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: true,
            alternative_names: vec![],
            file_indicators: vec!["application.conf".to_string()],
        },
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.95,
            dependency_patterns: vec!["org.apache.kafka:kafka-clients".to_string(), "spring-kafka".to_string(), "reactor-kafka".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.90,
            dependency_patterns: vec!["org.apache.spark:spark-core".to_string(), "org.apache.spark:spark-sql".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
            alternative_names: vec!["spark".to_string()],
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.90,
            dependency_patterns: vec!["org.apache.flink:flink-core".to_string(), "org.apache.flink:flink-streaming-java".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.85,
            dependency_patterns: vec!["org.apache.storm:storm-core".to_string(), "org.apache.storm:storm-client".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
        ...
        TechnologyRule {
            ...
            category: TechnologyCategory::Library(LibraryType::Utility),
            confidence: 0.75,
            dependency_patterns: vec!["org.apache.commons:commons-lang3".to_string(), "org.apache.commons:commons-io".to_string(), "org.apache.commons:commons-collections4".to_string()],
            requires: vec![],
            conflicts_with: vec![],
            is_primary_indicator: false,
